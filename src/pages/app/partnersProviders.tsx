...
export default function partnersProviders() {
    ...
    return (
        <>
            <Head>
                <title>Fornecedores Parceiros</title>
            </Head>
            <Layout>
                <div>
                    <div className={`flex flex-row items-center justify-center`}>
                        <h2 className="text-center text-3xl font-extrabold">Fornecedores Parceiros</h2>
                    </div>
                    <br />
                    <div className="bg-gray-200 mt-3 p-2 w-screen max-w-screen-md m-auto rounded-sm dark:text-gray-800">
                        <DataTable id="partnersProviders">
